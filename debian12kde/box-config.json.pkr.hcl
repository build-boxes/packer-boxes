...
source "virtualbox-iso" "autogenerated_1" {
  ...
  vboxmanage              = [["modifyvm", "{{ .Name }}", "--memory", "4096"], ["modifyvm", "{{ .Name }}", "--cpus", "2"], ["modifyvm", "{{ .Name }}", "--vram", "256"], ["modifyvm", "{{ .Name }}", "--graphicscontroller", "vmsvga"], ["modifyvm", "{{ .Name }}", "--natdnshostresolver1", "on"] ]
  virtualbox_version_file = ".vbox_version"
  vm_name                 = "packer-debian-12-kde-amd64"
}
...
build {
  ...
  post-processors {
    ...
    post-processor "vagrant-cloud" {
      box_tag = "raufhammad/debian12kde"
      version = "${var.version}"
    }
  }
}
